  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16 min-h-[calc(100vh-9rem)] flex flex-col justify-center">
      ...
      <div className="mb-10 text-center">
        ...
        <h1 className="text-3xl font-bold text-white mt-4 mb-2 tracking-tight">Private Notes</h1>
      ...
      <div className="border border-[#222] bg-[#0d0d0d] rounded-sm mb-4">
        <div className="border-b border-[#1a1a1a] px-4 py-3 flex items-center justify-between">
          <span className="text-xs text-[#555] tracking-widest uppercase">My Notes</span>
          <span className="flex items-center gap-2 text-[10px] text-[#333] tracking-widest uppercase">
        ...
        <textarea
          ...
          rows={10}
          className="w-full bg-transparent text-[#e5e5e5] placeholder-[#333] px-4 py-4 text-sm leading-relaxed focus:outline-none resize-none"
        />
        <div className="border-t border-[#1a1a1a] px-4 py-2 flex items-center justify-between text-[10px] text-[#333] tracking-widest uppercase">
      ...
      {savedAt && (
        <div className="fade-in mt-6 border border-[#1a1a1a] bg-[#0d0d0d] p-4 text-xs text-[#444] space-y-1">
          <p>✓ Note encrypted</p>
      ...
      <div className="mt-16 border-t border-[#1a1a1a] pt-8">
        <p className="text-[#333] text-xs leading-relaxed">
          <span className="text-[#444]">Privacy guarantee:</span> Because we never store your notes,
